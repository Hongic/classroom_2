...
<body>
	...
	<table>
		<tr>
			...
			<th class="centh">发表者</th>
			<th class="centh">发布时间</th>
			<th class="centh">点击量</th>
	...
	?>
		<tr>
			...
			<td class="center" style="width: 660px;"
				style="text-align: left; padding-left: 3px;"><?php echo substr_ch ( $row['content'], 200, 0, 'UTF-8' ); ?></td>
			<td class="center" style="width: 100px;"><?php echo $row['promulgator']; ?></td>
