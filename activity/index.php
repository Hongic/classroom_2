...
<body>
	...
	<table>
		<tr>
			...
			<th class="centh">内容</th>
			<th class="centh">作者</th>
			<th class="centh">发表时间</th>
			<th class="centh">点击率</th>
...
$pageSize = 8; // 每页显示的记录数
$total = @mysql_num_rows ( mysql_query ( "SELECT * FROM `tb_activity`" ) ); // 查询总记录！
...
$sql = "SELECT * FROM `tb_activity` order by `id` desc limit $firstcount,$pageSize";
...
while ( $row = @mysql_fetch_array ( $sql ) ) {
	?>
		<tr>
			...
			<td class="center" style="width: 190px;"><a
			...
			<td class="center" style="width: 660px;"
				...
				<td class="center" style="width: 100px;"><?php echo $row['author']?></td>
			<td class="center" style="width: 100px;"><?php echo $row['pubtime']; ?></td>
			<td class="center" style="width: 100px;"><?php echo $row['clicks']; ?></td>
