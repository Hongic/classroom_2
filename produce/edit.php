...
<title>编辑成员</title>
<link type="text/css" rel="stylesheet" href="../public/css/produce.css">
<script type="text/javascript" src="../public/js/produce.js"></script>
</head>
<body>
...
$sql = mysql_query ( "select * from tb_produce where id =$eid" );
...
<form action="edit_ok.php?eid='<?php echo $row['id']?>'" method="post"
		...
		<table>
			...
			<tr>
				<td class="r">图片：</td>
				<td><input type="file" name="file" class="in"
					value="<?php echo $row['produce'];?>"></td>
			</tr>
