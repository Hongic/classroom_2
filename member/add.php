...
<body>
	<form action="add_ok.php" method="post" name="form"
		onsubmit="return checkr_form(form)"
			 enctype="multipart/form-data">
		<table>
			<tr>
				<td class="r">成员名：</td>
				<td><input type="text" name="member" class="in"></td>
			</tr>
			<tr>
				<td class="r">年级：</td>
				<td><input type="text" name="grade" class="in"></td>
			</tr>

			<tr>
				<td class="r">学习方向：</td>
				<td><input type="text" name="direction" class="in"></td>
			</tr>
